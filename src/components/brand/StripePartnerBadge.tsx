export function StripePartnerBadge({ className = '' }: { className?: string }) {
  return (
    <div
      className={`inline-flex items-center gap-2 rounded-lg border border-white/15 bg-white/5 px-3 py-2 ${className}`}
      aria-label="Stripe Verified Partner"
    >
      <svg viewBox="0 0 60 25" className="h-5 w-auto" aria-hidden>
        <path
          fill="#635BFF"
